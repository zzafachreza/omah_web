                    ...
                    <?php echo ucfirst(str_replace("_"," ",$col->Comment)) ?> 
                      ...
                      <?php 
                       ...
                       <select  name="<?php echo $col->Field ?>" class="form-control selectza">
            				...
            				<option <?php echo $data->{$col->Field}=='Mitos atau Fakta<'?'selected':'' ?> >Mitos atau Fakta</option>
                          <option <?php echo $data->{$col->Field}=='Rekomendasi Makanan Sehat'?'selected':'' ?> >Rekomendasi Makanan Sehat</option>
                          <option <?php echo $data->{$col->Field}=='Asupan Kalori Tambahan'?'selected':'' ?> >Asupan Kalori Tambahan</option>
                          <option <?php echo $data->{$col->Field}=='Banner'?'selected':'' ?> >Banner</option>
