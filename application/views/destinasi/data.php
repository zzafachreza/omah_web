...
<div class="container-fluid">
  ...
  <div class="card">
    <div class="card-header">
      ...
      <!-- <a href="<?php echo site_url($modul.'/download') ?>" class="btn btn-warning"><i class="flaticon-download"></i> Download</a>
      <a href="<?php echo site_url($modul.'/add_import') ?>" class="btn btn-primary"><i class="flaticon-upload"></i> Upload Produk</a>
      <a onClick="return confirm('Apakah kamu yakin akan clear data ini ?')" href="<?php echo site_url($modul.'/clear') ?>" class="btn btn-danger"><i class="flaticon-delete"></i> Clear Data</a> -->
    </div>
    <div class="card-body">
 ...
 $sqlKolom = "SHOW FULL COLUMNS FROM data_$modul WHERE FIELD NOT IN('id_$modul','gambar1','gambar2','gambar3','deskripsi','jam_buka')";
                  ...
                  <td><?php echo $no; ?></td>
                   ...
                   <?php 
                      foreach($this->db->query($sqlKolom)->result() as $k){
                          ...
                          ?>
                           <td><img src="<?php echo site_url().$row->{$k->Field} ?>" height="100" /></td>

                           <?php }else if($k->Field=='link_youtube'){

                          
                          ?>
                             <td><img src="<?php echo 'https://i.ytimg.com/vi/'.$row->{$k->Field}.'/hq720.jpg' ?>" width="250" />
                            <br/><strong><?php echo $row->{$k->Field} ?></strong>
                           </td>
