...
class Penggunakamar extends CI_Controller{
    ...
    function add(){
        ...
        $this->load->view('footer');
            ...
            function detailbersih(){
        $data['title']=$this->modul().' - Detail';
        $data['modul'] = $this->modul();

        $this->load->view('header',$data);
        $this->load->view($this->modul().'/view_kebersihan');
        $this->load->view('footer');
    }

          function detailpribadi(){
        $data['title']=$this->modul().' - Detail';
        $data['modul'] = $this->modul();

        $this->load->view('header',$data);
        $this->load->view($this->modul().'/view_pribadi');
        $this->load->view('footer');
    }
