...
function get_data(){
  ...
  $sql="SELECT * FROM data_pengguna a JOIN data_jenispekerjaan b ON a.fid_jenispekerjaan = b.id_jenispekerjaan WHERE nomor_id='$nomor_id' limit 1";
